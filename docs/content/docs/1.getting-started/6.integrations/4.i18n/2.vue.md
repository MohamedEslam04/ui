...
Use the `locale` prop with the locale you want to use from `@eslamdevui/ui/locale`:

```vue [App.vue]
<script setup lang="ts">
import { fr } from '@eslamdevui/ui/locale'
</script>
...
```vue [App.vue]
<script setup lang="ts">
import type { Messages } from '@eslamdevui/ui'
import { defineLocale } from '@eslamdevui/ui/composables/defineLocale.js'
...
```vue [App.vue]
<script setup lang="ts">
import { en } from '@eslamdevui/ui/locale'
import { extendLocale } from '@eslamdevui/ui/composables/defineLocale.js'
